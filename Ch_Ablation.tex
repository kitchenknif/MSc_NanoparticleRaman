...
\hlb{SM: Please, add some short conclusion that fs-laser ablation allows for gentle removing of material from surface. Some estimation for silicon might be done. Also, you can say that there still no rigorous theoretical study on laser printing of Si nanoparticles }
