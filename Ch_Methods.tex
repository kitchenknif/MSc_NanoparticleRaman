...
\label{ch:Exp}
    ...
    \subsection{\hlr{Fabrication of crystalline silicon nanoparticles by femtosecond laser ablation}}
    \label{sec:Ablation}
        ...
        \subsubsection{\hlb{Laser transfer of crystalline dielectric particles}}
        ...
        \subsubsection{\hlb{Laser writing of dielectric particles}}
    ...
    \subsection{\hlb{Optical Measurements}}
        ...
        \subsubsection{\hlb{Polarization-Resolved Dark-field Spectroscopy of Single Nanoparticles}}
            \label{sec:Darkfield}
    ...
    \subsection{\hlb{Analytical model of Raman signal enhancement by Mie resonances of nanoparticles}}
        \label{sec:Theory}
