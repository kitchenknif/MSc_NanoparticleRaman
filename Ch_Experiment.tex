...
\section{Experimental Results}
    \subsection{\hlb{Fabrication of Crystalline Silicon Nanoparticles}}
        ...
        \subsubsection{\hlb{Laser Writing of Nanoparticles}}
            ...
            \begin{figure}[h!]
                    ...
                    % \caption{\textbf{А}. Сравнение спектров комбинационного рассеяния
                    % дифрактометрии плотноупакованного массива наночастиц}
            \end{figure}
        ...
        \subsubsection{\hlb{Laser Transfer of Nanoparticles}}
            ...
            corresponding to certain crystalline planes (Fig.~\ref{fig:Crystallinity}C). \hlb{Because the specimen grids were uneven, the
    ...
    \subsection{\hlb{Characterization of Resonant Optical Modes of the Nanoparticles}}
        ...
        \begin{figure}[h!]
                ...
                Numerically calculated electric field distributions in the silicon nanoparticle with a$_{\perp}$ = 85~nm
                 the wavelengths of 635~nm (G) and 525~nm (H).\hlb{TODO: UPDATE PICTURE}}\label{DF}
        \end{figure}
    ...
    \subsection{\hlb{Raman Scattering Enhancement from Single Nanoparticles}}
        ...
        fabrication are in \hlb{Methods}). In order to determine the resonant properties of nanoparticles, we measure
        their scattering spectra in the dark-field scheme (Fig.~\ref{Fig3}a, see \hlb{Methods} below).
        ...
        these calculations see \hlb{Methods}). The results of numerical modeling are shown in Fig.~\ref{Fig3}a, and they exhibit a
